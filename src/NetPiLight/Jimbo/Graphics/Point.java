...
/**
 * This class represents a point on the x,y plane. It's held as a purely integer
 * point where both x and y are greater then or equal to zero.
 *
 * @author Jim Darby
 */
public class Point {
    ...
    /**
     * Create a point with the given x and y coordinates. Both of these must be
     * greater than or equal to zero as they represent a point on a display.
     *
