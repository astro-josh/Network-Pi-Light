...
public class HT16K33 {
    ...
    /**
     * Turn the main oscillator on or off. Having the oscillator off is standby
     * mode and on is the normal run mode.
     *
    ...
    /**
     * Set the display parameters. There is an on/off boolean and the blink rate
     * which can be one of DISPLAY_STEADY (where it's on permanently),
    ...
    /**
     * Set a single bit in the display on or off. Bits are number from byte zero
     * upwards and inside a byte from LSB to MSB.
     *
    ...
    /**
     * Set a specific word in the buffer. The words are stored in little endian
     * format.
     *
     * @param which Which byte to set (0 to 15).
     * @param value The value to set it to.
     ...
     *
     * @throws IOException In case of trouble.
     * @throws com.pi4j.io.i2c.I2CFactory.UnsupportedBusNumberException In case
     * of trouble.
