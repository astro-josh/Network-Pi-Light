 ...
 * changes on the BananaPro.
 *
 * The internal resistance is set to PULL UP by default. So when connecting GPIO
 * pin #2 to a ground pin, you should see the GpioPinListenerDigital fire the
 * event.
 *
