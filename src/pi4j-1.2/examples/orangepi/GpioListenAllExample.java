...
public class GpioListenAllExample {
    ...
    public static void main(String args[]) throws InterruptedException, PlatformAlreadyAssignedException {
        ...
        GpioPinDigitalInput[] event_pins = {
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_00, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_02, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_03, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_04, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_05, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_06, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_07, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_10, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_11, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_12, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_13, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_14, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_15, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_16, pull),};
        ...
        GpioPinDigitalInput[] polled_pins = {
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_01, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_08), // I2C pin permanently pulled up
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_09), // I2C pin permanently pulled up
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_21, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_22, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_23, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_24, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_25, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_26, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_27, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_28, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_29, pull),
            gpio.provisionDigitalInputPin(OrangePiPin.GPIO_31), // this pin is permanently pulled up
        };
