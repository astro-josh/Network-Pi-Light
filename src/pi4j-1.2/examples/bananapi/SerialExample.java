 ...
 * BananaPi. (see 'BananaPiSerial' for constant definitions for BananaPi Serial
 * Port addresses.)
 *
...
public class SerialExample {
    ...
    public static void main(String args[]) throws InterruptedException, IOException, PlatformAlreadyAssignedException {
        ...
        try {
            ...
            //
            // by default, use the DEFAULT com port on the BananaPi (exposed on GPIO header)
            ...
            config.device(BananaPiSerial.DEFAULT_COM_PORT) // TX is located at CON3-08; RX is located at CON3-10
                    .baud(Baud._38400)
