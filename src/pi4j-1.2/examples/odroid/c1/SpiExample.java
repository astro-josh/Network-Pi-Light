 ...
 * the Odroid C1/C1+. Only CS0 (chip-select) is supported for SPI0 out of the
 * box.
 *
 * Don't forget to load the SPI kernel modules to provide access to device
 * "/dev/spidev0.0" > sudo modprobe spicc > sudo modprobe spidev
 *
