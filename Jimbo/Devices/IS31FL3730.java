...
public class IS31FL3730 {
     ...
     *
     * @param mode You can have (or not) MODE_SSD, MODE_AE and one of: MODE_8X8,
     * MODE_7X9, MODE_6X10 or MODE_9X11 and one of: MODE_M1, MODE_M2 or
     * MODE_M12.
    ...
    /**
     * Write the M1 matrix data and then (maybe) hit the update register. This
     * needs between 1 to 12 bytes of data but the 12th (if there) isn't used
     * for anything useful except triggering the device to update.
     *
    ...
    /**
     * Set the number of tries before logging a warning. Note this will never
     * log if there isn't a retry.
     *
