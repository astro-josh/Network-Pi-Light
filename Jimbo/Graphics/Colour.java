...
public class Colour {
    ...
    /**
     * Create from red, green and blue values. All in the range 0 to 255. If
     * this condition isn't met it will throw an IllegalArgumentException.
     *
    ...
    /**
     * Create the colour from an angle (in degrees) in a colour wheel. 0 is full
     * red, 120 is full green and 240 is full blue. It must be in the range 0 to
     * 360 inclusive. If this condition isn't met it will throw an
